...
public class ExecptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleInvObjectNotFound(
    ...
    /**
     * Handles ValidationExpection.
     *
     * @param ex the ValidationExpection
     * @return the Error object
     */
    @ExceptionHandler(ValidationExpection.class)
    protected ResponseEntity<Object> handleInvObjectNotFound(
            ValidationExpection ex) {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        //logger.info("{} to {}", servletWebRequest.getHttpMethod().toString(), servletWebRequest.getRequest().getServletPath());
    ...
    protected ResponseEntity<Object> buildResponseEntity(Error apiError) {
